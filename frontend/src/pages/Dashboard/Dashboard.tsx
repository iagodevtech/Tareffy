  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-xl text-gray-600">Bem-vindo ao Tareffy! Aqui está um resumo do seu trabalho.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <h3 className="text-base font-medium text-gray-500">Total de Tarefas</h3>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <h3 className="text-base font-medium text-gray-500">Em Progresso</h3>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <h3 className="text-base font-medium text-gray-500">Concluídas</h3>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <h3 className="text-base font-medium text-gray-500">Projetos</h3>
