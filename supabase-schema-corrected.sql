-- Supabase Database Schema for Tareffy - Corrected Version
-- This script ensures proper order of execution and handles missing tables

-- Set search path
SET search_path = public, auth;

-- Drop existing tables first (if they exist) - this will also drop all policies
